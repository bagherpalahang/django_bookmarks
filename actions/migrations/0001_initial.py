# Generated by Django 4.2.4 on 2023-10-10 07:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created'],
                'indexes': [models.Index(fields=['-created'], name='actions_act_created_64f10d_idx'), models.Index(fields=['-target_ct', 'target_id'], name='actions_act_target__7c12d1_idx')],
            },
        ),
    ]
